    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        listsViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            ...
            public void onChanged(@Nullable String s) {
                ...
                movies2[0] = new Movie(49051,"The Hobbit: An Unexpected Journey", "/yHA9Fc37VmpUA5UncTxxo3rTGVA.jpg", "en", "Bilbo Baggins, a hobbit enjoying his quiet life, is swept into an epic quest by Gandalf the Grey and thirteen dwarves who seek to reclaim their mountain home from Smaug, the dragon.");
                movies2[1] = new Movie(1891,"The Empire Strikes Back", "/7BuH8itoSrLExs2YZSsM01Qk2no.jpg", "en", "The epic saga continues as Luke Skywalker, in hopes of defeating the evil Galactic Empire, learns the ways of the Jedi from aging master Yoda. But Darth Vader is more determined than ever to capture Luke. Meanwhile, rebel leader Princess Leia, cocky Han Solo, Chewbacca, and droids C-3PO and R2-D2 are thrown into various stages of capture, betrayal and despair.");
                movies2[2] = new Movie(329,"Jurassic Park", "/9i3plLl89DHMz7mahksDaAo7HIS.jpg", "en", "A wealthy entrepreneur secretly creates a theme park featuring living dinosaurs drawn from prehistoric DNA. Before opening day, he invites a team of experts and his two eager grandchildren to experience the park and help calm anxious investors. However, the park is anything but amusing as the security systems go off-line and the dinosaurs escape.");
                movies2[3] = new Movie(11,"Star Wars", "/iTQHKziZy9pAAY4hHEDCGPaOvFC.jpg", "en", "Princess Leia is captured and held hostage by the evil Imperial forces in their effort to take over the galactic Empire. Venturesome Luke Skywalker and dashing captain Han Solo team together with the loveable robot duo R2-D2 and C-3PO to rescue the beautiful princess and restore peace and justice in the Empire.");
                movies2[4] = new Movie(1771,"Captain America: The First Avenger", "/vSNxAJTlD0r02V9sPYpOjqDZXUK.jpg", "en", "During World War II, Steve Rogers is a sickly man from Brooklyn who's transformed into super-soldier Captain America to aid in the war effort. Rogers must stop the Red Skull – Adolf Hitler's ruthless head of weaponry, and the leader of an organization that intends to use a mysterious device of untold powers for world domination.");

                Movie[] movies3 = new Movie [3];
                movies3[0] = new Movie(616037,"Thor: Love and Thunder", "/ifx23jgqQ8ZjUb9eiGjwbKtf0qQ.jpg", "en", "The fourth installment of the Marvel Studios' Thor movie series.");
                movies3[1] = new Movie(507086,"Jurassic World: Dominion", "/4lCQirdaxCHBCeTmwHw7zITx521.jpg", "en", "Plot unknown.");
                movies3[2] = new Movie(497698,"Black Widow", "/qAZ0pzat24kLdO3o8ejmbLxyOac.jpg", "en", "Natasha Romanoff, also known as Black Widow, confronts the darker parts of her ledger when a dangerous conspiracy with ties to her past arises. Pursued by a force that will stop at nothing to bring her down, Natasha must deal with her history as a spy and the broken relationships left in her wake long before she became an Avenger.");

                addListToPage(movies,"My Movies", 0);

                addListToPage(movies2,"Favorites", 1);

                addListToPage(movies3,"Watchlist", 3);
